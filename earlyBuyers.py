...
class EarlyBuyers:
    ...
    def fetchEarlyBuyers(self, contractAddress: str, useProxies = False, buyers = 50):
    ...
    def earlyBuyersdata(self, contractAddresses, threads=40, useProxies = False, buyers = 50):
